...
#+begin_src jupyter-python :session py :exports both :async yes :eval never-export
  ...
  with h5py.File('/home/gpu_user1/Documents/data/mayo.hdf5', 'w') as hf:
...
#+RESULTS:
: loading patient data: 100% 9/9 [00:25<00:00,  2.87s/it]
: loading patient data: 100% 1/1 [00:01<00:00,  1.95s/it]
: done
...
#+begin_src jupyter-python :session py :exports both :async yes :eval never-export
    ...
    with h5py.File('/home/gpu_user1/Documents/data/mayo.hdf5', 'r') as hf:
    ...
    samples_path = '/home/gpu_user1/Documents/data/cem_samples.hdf5'
