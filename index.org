...
#+RESULTS:
:RESULTS:
: loading patient data: 100% 9/9 [01:41<00:00, 11.25s/it]
:
: loading patient data: 100% 1/1 [00:11<00:00, 11.18s/it]
:
[[file:./.ob-jupyter/bed136635914bbec7f8405a2daccf8f4e60d5c39.png]]
:END:
...
#+begin_src jupyter-python :session py :exports both :async yes :eval never-export
  ...
  _ = fig.tight_layout()
  _ = axs[0, 0].set_title("full dose image")
  _ = axs[0, 0].imshow(utils.window_image(fd_data, ww, wl), cmap=plt.cm.Greys_r)
  _ = axs[0, 1].set_title("ultra low dose image")
  _ = axs[0, 1].imshow(utils.window_image(uld_data, ww, wl), cmap=plt.cm.Greys_r)
  _ = axs[1, 0].set_title("CEM mean")
  _ = axs[1, 0].imshow(utils.window_image(sample_mean, ww, wl), cmap=plt.cm.Greys_r)
  _ = axs[1, 1].set_title("CEM variance")
  #_ = axs[1, 1].imshow(wd(sample_variance), **imkwargs)
  _ = axs[1, 1].imshow(utils.normalize_to_greyscale(sample_variance))
...
#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/63b08e43e57d32a0dc2a17c69e9235322bb34420.png]]
: MSE(uld, fd) 741.0283824074941
