...
#+begin_src jupyter-python :session py :exports both :async yes :eval never-export
  ...
  fig, (ax1, ax2, ax3) = plt.subplots(1, 3, figsize=(8, 4.5), sharex=True, sharey=True)
  figures = [('Ground Truth', ax1, utils.window_densities(fd_data, ww, wl)),
           ('Low Dose Image', ax2, utils.window_densities(ld_data, ww, wl)),
             ('Ultra Low Dose Image', ax3, utils.window_densities(uld_data, ww, wl))]
...
#+RESULTS:
:RESULTS:
: loading patient data: 100% 9/9 [03:54<00:00, 26.03s/it]
: loading patient data: 100% 1/1 [00:22<00:00, 22.29s/it]
[[file:./.ob-jupyter/57878659e054be1078d3413b3b2cb6ce33eae3b5.png]]
:END:
...
#+begin_src jupyter-python :session py :exports both :async yes :eval never-export
  ...
  fd_img = utils.window_densities(fd_data.reshape((fd_data.shape[0], fd_data.shape[1])), ww, wl)
  ld_img = utils.window_densities(ld_data, ww, wl)
  uld_fbp = utils.window_densities(mayo.add_noise(fd_data.reshape((fd_data.shape[0], fd_data.shape[1])), N0=30000), ww, wl)
  figures = [('Normal Dose', axs[0, 0], fd_img),
             ('Low Dose', axs[0, 1], ld_img),
             ('Image + Noise', axs[1, 0], utils.window_densities(mayo.add_simple_noise(fd_data, peak=2), ww, wl)),
             ('Image = Projection + Noise', axs[1, 1], uld_fbp),
             ]

  for title, ax, image in figures:
    ax.grid(None)
    ax.set_title(title)
    ax.imshow(image, cmap=plt.cm.Greys_r)
  ...
  print(f'{np.mean((uld_fbp - fd_img)**2)} vs {np.mean((ld_img - fd_img)**2)}')
#+end_src
...
: [1;32m      6[0m [38;5;28;01mimport[39;00m [38;5;21;01mmayo[39;00m[38;5;241m,[39m [38;5;21;01mutils[39;00m
: [1;32m      8[0m [38;5;28;01mwith[39;00m h5py[38;5;241m.[39mFile([38;5;124mf[39m[38;5;124m'[39m[38;5;132;01m{[39;00mPath[38;5;241m.[39mhome()[38;5;132;01m}[39;00m[38;5;124m/Documents/data/mayo.hdf5[39m[38;5;124m'[39m, [38;5;124m'[39m[38;5;124mr[39m[38;5;124m'[39m) [38;5;28;01mas[39;00m hf:
: [0;32m----> 9[0m   fd_data, ld_data [38;5;241m=[39m hf[[38;5;124m'[39m[38;5;124mtest[39m[38;5;124m'[39m][[38;5;241m36[39m]
: [1;32m     11[0m ww [38;5;241m=[39m [38;5;241m350[39m
: [1;32m     12[0m wl [38;5;241m=[39m [38;5;241m50[39m
:
