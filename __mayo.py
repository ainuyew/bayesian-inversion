...
from pydicom.datadict import DicomDictionary, keyword_dict #NameDict, CleanName
#from odl.discr.discr_utils import linear_interpolator
from discr_utils import linear_interpolator
...
def _read_projections(folder, indices):
    ...
    for i, file_name in enumerate(tqdm.tqdm(file_names,
        ...
        hu_factor = dataset.WaterAttenuationCoefficient
...
def load_projections(folder, indices=None):
    ...
    angle_partition = odl.nonuniform_partition(np.sort(angles))
